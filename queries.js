...
“orderDemo” which will have 5 columnsi. id (Integer ,Primary key)
...
SELECT emp_no, salary, department FROM employees WHERE salary <
35000;
...
SELECT emp_no, first_name, department FROM employees WHERE
department != 'IT';
...
SELECT emp_no, first_name, department FROM employee WHERE
department NOT LIKE '%ing% ';

4) Select all employees whose last name starts with ‘w’ and has
emp_no more than 1015.

SELECT * FROM employee WHERE last_name LIKE 'w%' AND emp_no
> 1015;
